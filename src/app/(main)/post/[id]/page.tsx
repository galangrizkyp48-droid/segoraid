...
import { Heart, MessageCircle, Share2, ShoppingCart, ArrowLeft, MoreVertical, MapPin } from 'lucide-react'
...
export default function PostDetailPage() {
    ...
    return (
        <div className="min-h-screen bg-white pb-24">
            ...
            {/* Bottom Action Bar */}
            <div className="fixed bottom-0 left-0 right-0 bg-white border-t p-4 px-6 md:static md:border-t-0 md:bg-transparent md:p-0">
